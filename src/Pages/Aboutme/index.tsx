...
const Aboutme = () => {
  return (
    <div
      id="aboutme"
      className="pt-[100px] container items-center justify-between  my-12 first-letter flex flex-col p-4"
    >
      ...
      <div className="flex items-center justify-center flex-col lg:flex-row ">
        <p className="text-xl text-center lg:text-left font-normal text-[#747272] pt-8 flex-[1.5]">
          Hello! I'm a passionate front-end developer with expertise in creating
          ...
          provide optimal user experiences. <br />
